...
import 'package:stack_slider_animation_music/idial_file/page_transitions.dart';
import 'package:stack_slider_animation_music/idial_file/playlist_page.dart';
...
class _FeaturedLibraryItemsState extends State<FeaturedLibraryItems> {
  ...
  @override
  void initState() {
    offsetAnimationTween = Tween<double>(begin: 0, end: -1000);
